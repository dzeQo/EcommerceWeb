        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              <a href="{{url('admin/ManageOrders')}}" class="float-right btn btn-sm btn-dark">All Orders</a>
            </div>
            <div class="card-body"> 
              <div class="table-responsive">
                ...
                <form method="post" action="{{url('admin/ManageOrders/'.$orderToEdit->id.'/edit')}}" enctype="multipart/form-data">
                  @csrf
                  @method('put')
